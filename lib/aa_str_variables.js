...
// adm error messages
err_access_adm_msg = "Acesso apenas permitido para administradores!";

// insert error messages
err_insert_cat_proc_msg = "Erro no processo de inser\u00e7\u00e3o do catador!";
err_insert_cat_prof_msg = "Erro na inser\u00e7\u00e3o do perfil do catador.";
...
err_insert_compl_addr_msg = "Erro na inser\u00e7\u00e3o do catador! - campo endere\u00e7o de refer\u00eancia \u00e9 obrigat\u00f3rio (necess\u00e1rio clicar na sugest\u00e3o)";

// update error messages
err_update_cat_proc_msg = "Erro no processo de atualiza\u00e7\u00e3o do catador!";
err_update_cat_prof_msg = "Erro na atualiza\u00e7\u00e3o do perfil do catador.";
...
err_update_photo_proc_msg = "Erro no processo de atualiza\u00e7\u00e3o da foto do catador!";
err_update_hist_photo_msg = "Erro na atualiza\u00e7\u00e3o do hist\u00f3rico da foto.";

// success messages
succ_insert_cat_msg = "Catador inserido com sucesso!";
succ_update_cat_msg = "Catador atualizado com sucesso!";
succ_update_photo_msg = "Foto atualizada com sucesso!";
...
//For all user regular screens: P - Pending, A - Approved
statusShow = ['P', 'A'];

//For delete and moderation adm screens: P - Pending, A - Approved, R - Rejected
statusShowDelMod = ['P', 'A', 'R'];